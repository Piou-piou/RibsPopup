...
var _ribsCore = __webpack_require__(61);

var _ribsCore2 = _interopRequireDefault(_ribsCore);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var RibsPopup = function () {
  /**
  ...
  function RibsPopup() {
    ...
    (0, _classCallCheck3.default)(this, RibsPopup);

    var links = document.querySelectorAll('[data-ribspopup]');

    (0, _from2.default)(links).forEach(function (element) {
  ...
  (0, _createClass3.default)(RibsPopup, [{
    key: 'openPopup',
    value: function openPopup(event) {
      ...
      var dataPopup = event.currentTarget.dataset.popup;
      var popup = document.getElementById(dataPopup);

      popup.classList.add('displayed');

      popup.querySelector('.link .cancel').addEventListener('click', function (event) {
        return _this2.closePopup(event);
      });
    }
    ...
    value: function closePopup(event) {
      ...
      var popup = this.parents(event.currentTarget, '.popup');
    ...
    key: 'parents',
    value: function parents(element, wanted) {
    ...
    key: 'checkWanted',
    value: function checkWanted(wanted) {
      if (wanted.indexOf('.') !== -1) {
        return 'class';
...
exports.default = RibsPopup;


var popup = new RibsPopup();
...
var RibsCore = function () {
  function RibsCore() {
    (0, _classCallCheck3.default)(this, RibsCore);
  }

  (0, _createClass3.default)(RibsCore, null, [{
    key: 'getHeight',
    ...
    key: 'toggleSlide',
    value: function toggleSlide(element, duration) {
      var maxHeight = 0;
    ...
    key: 'wrap',
    value: function wrap(element, newElement) {
      var className = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

      var parentElement = element.parentNode;
      var wrapper = document.createElement(newElement);
